...
public class MainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener, SelectViewPager , OnFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_history:
                Intent hisIntent=new Intent(MainActivity.this, HistoryScreen.class);
            ...
            *//*    Fragment frag = new CustomFragment();
            ...
            case R.id.nav_share:
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "Coming Soon...   VLove ");
                startActivity(Intent.createChooser(intent, "Share"));
        break;
            case R.id.nav_logout:
                Intent intentLogout = new Intent(MainActivity.this, LoginSignUp.class);
